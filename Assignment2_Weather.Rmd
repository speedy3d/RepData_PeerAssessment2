...
```{r}
#par(mfrow=c(1,2))
stacked <- table(top_10_total_injuries$x, top_10_total_fatalities$x)
barplot(stacked, main="Top 10 Events by Total Injuries", ylab="Total Number of Weather-Related Injuries", col="blue", legend=rownames(stacked))
#barplot(top_10_total_injuries$x, names.arg=top_10_total_injuries$Event, main="Top 10 Events by Total Injuries", ylab="Total Number of Weather-Related Injuries", col="blue")
```