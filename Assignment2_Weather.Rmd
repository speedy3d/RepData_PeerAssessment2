...
```{r}
barplot(top_10_total_damage$x, names.arg=top_10_total_damage$Event, ylab="Total Economic Damage", main="Weather-Related Events with the Highest Economic Impact", las=3, cex.names=0.45)
```
